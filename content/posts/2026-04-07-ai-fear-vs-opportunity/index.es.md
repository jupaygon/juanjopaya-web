...
- **Qué es <a href="https://en.wikipedia.org/wiki/SOLID" target="_blank">SOLID</a>** y por qué hace que el código sea mantenible.
...
Tu MVP se convierte en lo que antes era el mockup de producto o de diseño, pero mucho más real, más vivo. Y el equipo de desarrollo puede basarse en él para construir algo <a href="https://en.wikipedia.org/wiki/SOLID" target="_blank">sólido</a> — con la arquitectura, los tests y la calidad que un producto necesita para escalar.
